/**
 * Page-level header for the PCF dashboard.
 *
 * Communicates *what the dashboard is for* without showing any
 * calculated KPI values — the data-bearing surfaces (cards, charts,
 * tables) are added in later steps.
 */
